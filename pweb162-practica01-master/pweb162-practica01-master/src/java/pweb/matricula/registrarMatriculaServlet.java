...
public class registrarMatriculaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        turnoCurso = request.getParameter("turnoC1"); 
        matriculaC1 = new Matricula(idAlumno, nombreCurso, creditosCurso, cicloCurso,turnoCurso);
        ...
        turnoCurso = request.getParameter("turnoC2"); 
        matriculaC2 = new Matricula(idAlumno, nombreCurso, creditosCurso, cicloCurso,turnoCurso);
        ...
        turnoCurso = request.getParameter("turnoC3"); 
        matriculaC3 = new Matricula(idAlumno, nombreCurso, creditosCurso, cicloCurso,turnoCurso);
        ...
        turnoCurso = request.getParameter("turnoC4"); 
        matriculaC4 = new Matricula(idAlumno, nombreCurso, creditosCurso, cicloCurso,turnoCurso);
